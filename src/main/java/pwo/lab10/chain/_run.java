...
public class _run {
    public static void main(String[] args) {
        ...
        Request request0 = new Request("Ala Ma Kota1234", "up");
        Request request1 = new Request("Ala Ma Kota1234", "down");
        Request request2 = new Request("Ala Ma Kota1234", "reverse");
        Request request3 = new Request("Ala Ma Kota1234", "?");
        Request request4 = new Request("Ala Ma Kota1234", "removenumbers");
